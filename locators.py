...
class Locators:
    ...
    LOGO_BTN = By.XPATH, './/div[1]/div/header/nav/div'  # Логотип "Stellar Burgers"
    CONSTRUCTOR_BTN = By.XPATH, './/p[text()="Конструктор"]'  # Кнопка "Конструктор"
    HEADER_MK_BURGER = By.XPATH, './/section[1]/h1[text()="Соберите бургер"]'  # Заголовок "Соберите бургер"
    ...
    EMAIL_INPUT = By.XPATH, './/fieldset[1]/div/div/input'  # Поле ввода email
    PWD_INPUT = By.XPATH, './/fieldset[2]/div/div/input'  # Поле ввода пароля
    ...
    REG_NAME_INPUT = By.XPATH, './/fieldset[1]/div/div/input'  # Поле ввода имени
    REG_EMAIL_INPUT = By.XPATH, './/fieldset[2]/div/div/input'  # Поле ввода email
    REG_PWD_INPUT = By.XPATH, './/fieldset[3]/div/div/input'  # Поле ввода пароля
    REG_BTN = By.XPATH, './/button[text()="Зарегистрироваться"]'  # Кнопка "Зарегистрироваться"
    ENTER_LINK = By.XPATH, './/a[text()="Войти"]'  # Ссылка "Войти"
    INCORRECT_PWD_MSG = By.XPATH, './/fieldset[3]/div/p[text()="Некорректный пароль"]'  # Сообщение"Некорректный пароль"
    ...
    REC_EMAIL_INPUT = By.XPATH, './/fieldset/div/div/input'   # Поле ввода email
